...
//altsyncram CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="input.hex" NUMWORDS_A=64 OPERATION_MODE="SINGLE_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" POWER_UP_UNINITIALIZED="FALSE" read_during_write_mode_port_a="NEW_DATA_NO_NBE_READ" WIDTH_A=16 WIDTH_BYTEENA_A=1 WIDTHAD_A=6 address_a clock0 data_a q_a wren_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.mem_init0 = 64'h0000000000000003,
	...
	defparam
		...
		ram_block1a_1.mem_init0 = 64'h0000000000000002,
	...
	defparam
		...
		ram_block1a_3.mem_init0 = 64'h0000000000000002,
	...
	defparam
		...
		ram_block1a_6.mem_init0 = 64'h0000000000000003,
	...
	defparam
		...
		ram_block1a_7.mem_init0 = 64'h0000000000000002,
	...
	defparam
		...
		ram_block1a_10.mem_init0 = 64'h0000000000000001,
	...
	defparam
		...
		ram_block1a_12.mem_init0 = 64'h0000000000000003,
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: Memory initialization file input.hex is not of the dimensions 64 X 16, the resulting memory design may not produce consistent simulation results.");
	end
